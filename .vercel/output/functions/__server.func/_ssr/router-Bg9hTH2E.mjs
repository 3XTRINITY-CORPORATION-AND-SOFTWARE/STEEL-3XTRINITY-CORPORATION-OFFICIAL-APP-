...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Bg9hTH2E.js
var router_Bg9hTH2E_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-7i-Btt72.css";
var APP_NAME = "STEEL";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Real-time ASIO pipelines to the web. FL Studio, Ableton Live 12, ASIO4ALL 2.22, Windows 8+ and Linux."
			},
			{
				name: "theme-color",
				content: "#111210"
...
var $$splitComponentImporter = () => import("./routes-CvvnFFZj.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_Bg9hTH2E_exports as t };
