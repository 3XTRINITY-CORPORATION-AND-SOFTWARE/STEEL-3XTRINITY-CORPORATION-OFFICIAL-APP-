...
//#region node_modules/.nitro/vite/services/ssr/assets/xlsx-Ck3TN02C.js
...
async function exportXlsx(report) {
	...
	[
		...
		summary.getCell(`C${r}`).value = { formula: `IF(SUM($B$2:$B$7)=0,0,B${r}/SUM($B$2:$B$7))` };
	...
	downloadBlob(new Blob([buf], { type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" }), `attest-${slugify(report.name)}.xlsx`);
}
//#endregion
export { exportXlsx };
